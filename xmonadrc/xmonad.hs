...
import XMonad.Hooks.ManageDocks --needed to manage xmobar positioning
import Graphics.X11.ExtraTypes.XF86 --needed for the function key
import XMonad.Layout.Spacing --needed to add spacing between windows

import qualified XMonad.StackSet as W
import qualified Data.Map        as M

-- hooks and stuff relating to xmobar
...
myStartupHook = do
            ...
            --spawnOnce "synclient VertScrollDelta=-113 &"
            --spawnOnce "synclient HorizScrollDelta=-113 &"
------------------------------------------------------------------------
...
--
main = do
  xmproc <- spawnPipe "xmobar-app"--spawnPipe "xmobar /home/endrit/.config/xmobar/xmobarrc"
